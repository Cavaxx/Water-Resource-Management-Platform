...
try:
    ...
    facilities_df.set_index("id_sito", inplace=True)  # Optional: Set an index for easier lookups if needed
...
def search_river():
    ...
    if river_name:
        ...
        # Query CSV data for facility information
...
if __name__ == '__main__':
    ...
    app.template_folder = "templates"  # Ensure the 'templates' directory is in the correct location
    print(app.template_folder)  # Should output "templates" if the folder is correctly set
